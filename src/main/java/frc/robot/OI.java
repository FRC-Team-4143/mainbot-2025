...
public abstract class OI {
  ...
  public static void configureBindings() {
    ...
    operator_controller_
        .y()
        .toggleOnTrue(new ElevatorL4Target().unless(Climber.getInstance()::lockOutControl).ignoringDisable(true));
    // Set L3 Target:
    ...
    operator_controller_
        .b()
        .toggleOnTrue(new ElevatorL3Target().unless(Climber.getInstance()::lockOutControl).ignoringDisable(true));
    // Set L2 Target:
    ...
    operator_controller_
        .x()
        .toggleOnTrue(new ElevatorL2Target().unless(Climber.getInstance()::lockOutControl).ignoringDisable(true));
    // Set L1 Target:
    ...
    operator_controller_
        .a()
        .toggleOnTrue(new ElevatorL1Target().unless(Climber.getInstance()::lockOutControl).ignoringDisable(true));
    ...
    operator_controller_
        ...
        .onTrue(
            Commands.runOnce(
                () -> GameStateManager.getInstance().setScoringColum(Column.LEFT, true)).ignoringDisable(true));
    ...
    operator_controller_
        ...
        .onTrue(
            Commands.runOnce(
                () -> GameStateManager.getInstance().setScoringColum(Column.RIGHT, true)).ignoringDisable(true));

    // Manual Adjust Elevator Setpoint Up
    operator_controller_
        .povUp()
        .onTrue(Commands.runOnce(() -> Elevator.getInstance().setOffset(OffsetType.ELEVATOR_UP)).ignoringDisable(true));
    // Manual Adjust Elevator Setpoint Down
    operator_controller_
        .povDown()
        .onTrue(Commands.runOnce(() -> Elevator.getInstance().setOffset(OffsetType.ELEVATOR_DOWN)).ignoringDisable(true));
    // Manual Adjust Arm Setpoint Counter Clockwise
    operator_controller_
        .povLeft()
        .onTrue(Commands.runOnce(() -> Elevator.getInstance().setOffset(OffsetType.ARM_CCW)).ignoringDisable(true));
    // Manual Adjust Arm Setpoint Clockwise
    operator_controller_
        .povRight()
        .onTrue(Commands.runOnce(() -> Elevator.getInstance().setOffset(OffsetType.ARM_CW)).ignoringDisable(true));
