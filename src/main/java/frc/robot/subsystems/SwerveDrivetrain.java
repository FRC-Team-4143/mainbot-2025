      ...
      case TRACTOR_BEAM:
        {
          ...
          this.setControl(
              auto_request_
                  .withVelocityX(
                      MathUtil.clamp(x_velocity, DrivetrainConstants.MAX_TRACTOR_BEAM_VELOCITY_SPEED))
                  .withVelocityY(
                      MathUtil.clamp(y_velocity, DrivetrainConstants.MAX_TRACTOR_BEAM_VELOCITY_SPEED))
                  .withRotationalRate(
                      MathUtil.clamp(omega, DrivetrainConstants.MAX_TRACTOR_BEAM_OMEGA_SPEED)));
        }
        break;
      case FOLLOW_POINT:
        {
