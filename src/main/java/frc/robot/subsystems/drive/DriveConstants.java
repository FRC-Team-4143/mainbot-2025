...
public class DriveConstants {
  ...
  public static final double ODOM_FREQ = 100.0; // Hz
  ...
  public static final double SLIP_CURRENT_AMPS =
  ...
  public static final double COUPLE_RATIO = LOADER.getDoubleValue("drive", "com", "COUPLE_RATIO");
  public static final double WHEEL_RADIUS_INCH =
      LOADER.getDoubleValue("drive", "com", "WHEEL_RADIUS_INCH");
  public static final boolean STEER_MOTOR_REVERSED =
