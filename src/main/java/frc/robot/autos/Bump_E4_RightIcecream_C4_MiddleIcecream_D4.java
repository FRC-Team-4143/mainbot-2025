...
public class Bump_E4_RightIcecream_C4_MiddleIcecream_D4 extends Auto {

  public Bump_E4_RightIcecream_C4_MiddleIcecream_D4() {
    // Register Trajectories first
    this.loadTrajectory("Bump Right Start to EF");
    this.loadTrajectory("EF to CD Icecream Right");
    this.loadTrajectory("CD to CD Icecream Middle");
    ...
    this.addCommands(
        ...
        // Get game piece 2
        new IntakeHandoff(),
        this.getTrajectoryCmd("EF to CD Icecream Right"),
        ...
        // Get game piece 3
        new IntakeHandoff(),
        this.getTrajectoryCmd("CD to CD Icecream Middle"),
