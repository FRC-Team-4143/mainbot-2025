...
public final class Constants {
  ...
  public class ClimberConstants {
    ...
    public static final double PRONG_DEPLOY_SPEED = 0.1;
    public static final double PRONG_HOLD_SPEED = -0.05;
    ...
    public static final double PRONG_PRESET_COUNT = 105;
    public static final double DEPLOYING_TIME = 1.2;
    public static final double PRONG_P = 0.004;
    public static final double PRONG_D = 0.0;
  }
