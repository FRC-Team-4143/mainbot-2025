...
public final class Constants {
        ...
        public static class Vision {
                ...
                public static final AprilTagFieldLayout TAG_LAYOUT = TagLayouts
                                .getTagLayoutFromPath("apriltagLayouts/onlyReef.json");
        ...
        d31e34e (Nathan's random changes)
                ...
                private static final double SLIP_CURRENT_AMPS = LOADER.getDoubleValue("drive", "com", "SLIP_CURRENT");
                private static final double SPEED_AT_12V_MPS = LOADER.getDoubleValue("drive", "com", "SPEED_AT_12V");
                private static final double COUPLE_RATIO = LOADER.getDoubleValue("drive", "com", "COUPLE_RATIO");
                private static final double WHEEL_RADIUS_INCH = LOADER.getDoubleValue("drive", "com",
                                "WHEEL_RADIUS_INCH");
                private static final boolean STEER_MOTOR_REVERSED = LOADER.getBoolValue("drive", "com",
                                "STEER_MOTOR_REVERSED");
                public static final double MAX_DRIVE_SPEED = LOADER.getDoubleValue("drive", "com", "MAX_DRIVE_SPEED");
                public static final double MAX_DRIVE_ANGULAR_RATE = LOADER.getDoubleValue("drive", "com",
                                "MAX_DRIVE_ANGULAR_RATE");
                ...
                public static final double CENTER_OFFSET_X = Units
                                .inchesToMeters(LOADER.getDoubleValue("drive", "com", "CENTER_OFFSET_X"));
        }
        ...
        public static final class ClawConstants {
                ...
                public static final double CORAL_IMP_OFFSET = Units
                                .inchesToMeters(LOADER.getDoubleValue("imp", "coral_offset"));
                public static final double ALGAE_IMP_OFFSET = Units
                                .inchesToMeters(LOADER.getDoubleValue("imp", "algae_offset"));
        ...
        public class ClimberConstants {
                ...
                public static final Slot0Configs STRAP_GAINS = new Slot0Configs().withKP(0.16).withKD(0.0).withKS(0.0)
                                .withKV(0.0).withKA(0.0);
        ...
        public class ElevatorConstants {
                ...
                public static final InvertedValue ELEVATOR_MASTER_INVERSION = InvertedValue.CounterClockwise_Positive;
                public static final InvertedValue ELEVATOR_FOLLOWER_INVERSION = InvertedValue.Clockwise_Positive;
                // Units.inchesToMeters(Sprocket Circumference * Math.PI) / gearbox ratio *
                // rigging
                public static final double ELEVATOR_ROTATIONS_TO_METERS = Units.inchesToMeters(1.751 * Math.PI)
                ...
                public static final double ELEVATOR_HEIGHT_PIVOT_MIN = Units
                                .inchesToMeters(LOADER.getDoubleValue("elevator", "HEIGHT_PIVOT_MIN"));
                public static final double ELEVATOR_HEIGHT_PIVOT_MAX = Units
                                .inchesToMeters(LOADER.getDoubleValue("elevator", "HEIGHT_PIVOT_MAX"))
                                - 0.1; // 0.1m of safety
                public static final double ELEVATOR_HEIGHT_PIVOT_SAFETY = ELEVATOR_HEIGHT_PIVOT_MIN
        ...
        public class ArmConstants {
                ...
                public static final InvertedValue ARM_FOLLOWER_INVERSION = InvertedValue.CounterClockwise_Positive;
                ...
                public static final double ARM_LENGTH = Units
                                .inchesToMeters(LOADER.getDoubleValue("arm", "LENGTH_PIVOT_TO_FUNNEL"));
                public static final double ARM_WIDTH = Units
                                .inchesToMeters(LOADER.getDoubleValue("arm", "DEPTH_CORAL_POCKET"));
                ...
                public static final double ARM_REVERSE_LIMT = Units.radiansToRotations(Units.degreesToRadians(-130));
        ...
        public static final class PickupConstatns {
                ...
                public static final Slot0Configs PICKUP_GAINS = new Slot0Configs().withKP(0.5).withKI(0.00)
                                .withKD(0.00);
        }
