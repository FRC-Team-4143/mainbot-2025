...
public final class Constants {
    ...
    public class DrivetrainConstants {
        ...
        private static final double WHEEL_RADIUS_INCH = LOADER.getDoubleValue("drive", "com", "WHEEL_RADIUS_INCH");
        private static final boolean STEER_MOTOR_REVERSED = LOADER.getBoolValue("drive", "com", "STEER_MOTOR_REVERSED");
    ...
    public class ElevatorConstants {
        ...
        public static final double ELEVATOR_HEIGHT_PIVOT_MAX = Units
                ...
                - 0.1; // 0.1m of safety
        public static final double ELEVATOR_HEIGHT_PIVOT_SAFETY = ELEVATOR_HEIGHT_PIVOT_MIN + Units.inchesToMeters(6);
    ...
    public class ArmConstants {
        ...
        public static final double ARM_WIDTH = Units.inchesToMeters(LOADER.getDoubleValue("arm", "DEPTH_CORAL_POCKET"));
