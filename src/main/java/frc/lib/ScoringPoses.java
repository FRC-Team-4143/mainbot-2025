...
public class ScoringPoses {
    ...
    public static final Transform2d ALGAE_ALIGN_OFFSET = new Transform2d(
    ...
    public static Pose2d RIGHT_CORAL_STATION_POSE = FieldConstants.CoralStation.RIGHT_CENTER_FACE
            .transformBy(CORAL_STATION_OFFSET);
    public static Pose2d PROCESSOR_POSE = FieldConstants.Processor.CENTER_FACE.transformBy(PROCESSOR_OFFSET);
    public static Pose2d BARGE_TIGHT_ROPE_POSE_A = new Pose2d(7.68, FieldConstants.FIELD_WIDTH - 0.914,
            Rotation2d.fromDegrees(0));
    public static Pose2d BARGE_TIGHT_ROPE_POSE_B = new Pose2d(7.68, (FieldConstants.FIELD_WIDTH / 2) - 0.914,
            Rotation2d.fromDegrees(0));
    public static TightRope BARGE_TIGHT_ROPE = new TightRope(BARGE_TIGHT_ROPE_POSE_A, BARGE_TIGHT_ROPE_POSE_B);

    public static Pose2d PROCESSOR_TIGHT_ROPE_POSE_A = FieldConstants.Processor.CENTER_FACE;
    public static Pose2d PROCESSOR_TIGHT_ROPE_POSE_B = FieldConstants.Processor.CENTER_FACE.transformBy(new Transform2d(-4, 0, new Rotation2d()));
    public static TightRope PROCESSOR_TIGHT_ROPE = new TightRope(PROCESSOR_TIGHT_ROPE_POSE_A,
            PROCESSOR_TIGHT_ROPE_POSE_B);
}
