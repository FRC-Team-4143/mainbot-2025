...
public class ElevatorTargets {
    private static final double coral_offset = 4;
    ...
    private static final TargetData STATION_INT = new TargetData(
    ...
    private static final TargetData L1_INT = new TargetData(
            FieldConstants.ReefHeight.L1.HEIGHT + Units.inchesToMeters(8),
            Units.degreesToRadians(-270),
            ControlType.EFFECTOR,
            "L1_INT");

    private static final TargetData CLIMB_INT = new TargetData(
            ElevatorConstants.ELEVATOR_HEIGHT_PIVOT_MIN + Units.inchesToMeters(12),
            Units.degreesToRadians(0),
            ControlType.PIVOT,
            "CLIMB_INT");

    public static TargetData CURRENT_STOW_INT = new TargetData(
            ElevatorConstants.ELEVATOR_HEIGHT_PIVOT_SAFETY + Units.inchesToMeters(12),
            Units.degreesToRadians(-120),
            ControlType.PIVOT,
            "CURRENT_STOW_INT");

    public static final TargetData HIGH_STOW_INT = new TargetData(
            ElevatorConstants.ELEVATOR_HEIGHT_PIVOT_SAFETY + Units.inchesToMeters(12),
            Units.degreesToRadians(-120),
            ControlType.PIVOT,
            "HIGH_STOW_INT");

    public static final TargetData LOW_STOW_INT = new TargetData(
            ElevatorConstants.ELEVATOR_HEIGHT_PIVOT_SAFETY + Units.inchesToMeters(6),
            Units.degreesToRadians(-120),
            ControlType.PIVOT,
            "LOW_STOW_INT");

    private static final TargetData ALGAE_STOW_ENTER = new TargetData(
            ElevatorConstants.ELEVATOR_HEIGHT_PIVOT_SAFETY + Units.inchesToMeters(12),
            Units.degreesToRadians(-270),
            ControlType.PIVOT,
            "ALGAE_STOW_ENTER");

    private static final TargetData CORAL_STOW_ENTER = new TargetData(
            ElevatorConstants.ELEVATOR_HEIGHT_PIVOT_SAFETY + Units.inchesToMeters(12),
            Units.degreesToRadians(-270),
            ControlType.PIVOT,
            "CORAL_STOW_ENTER");
    ...
    public enum TargetType {
        SAFETY(
                new TargetData(
                        ElevatorConstants.ELEVATOR_HEIGHT_PIVOT_SAFETY, // height is ignored for this special target
