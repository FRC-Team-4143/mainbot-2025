  ...
  public enum Target {
    L4(
        new TargetData(
            ...
            ControlType.EFFECTOR, ReefStagingAngle)),
    L3(
        new TargetData(
    ...
    ALGAE_PROCESSOR(
        new TargetData(
            0.6381 + Units.inchesToMeters(0), Rotation2d.fromDegrees(-55), ControlType.EFFECTOR, Optional.empty())),
    BARGE(
        new TargetData(
            2.159 + Units.inchesToMeters(0), Rotation2d.fromDegrees(90), ControlType.EFFECTOR, Optional.empty())),
    ALGAE_STOW(
        new TargetData(
