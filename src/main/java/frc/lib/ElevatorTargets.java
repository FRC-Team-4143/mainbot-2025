...
public class ElevatorTargets {
  public enum Target {
    L4(
        ...
        Optional.of(IntermediateTarget.L4_I), Optional.empty()),
    L3(
        new TargetData(
            FieldConstants.ReefHeight.L3.HEIGHT + Units.inchesToMeters(8),
            Rotation2d.fromDegrees(125),
            ControlType.EFFECTOR),
        Optional.of(IntermediateTarget.L3_I), Optional.empty()),
    L2(
        new TargetData(
            FieldConstants.ReefHeight.L2.HEIGHT + Units.inchesToMeters(8),
            Rotation2d.fromDegrees(125),
            ControlType.EFFECTOR),
        Optional.of(IntermediateTarget.L2_I), Optional.empty()),
    STATION(
        new TargetData(
    ...
    Target(TargetData td, Optional<IntermediateTarget> i_En_t, Optional<IntermediateTarget> i_Ex_t) {
      this.td = td;
