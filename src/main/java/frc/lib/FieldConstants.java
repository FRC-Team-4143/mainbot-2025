...
public class FieldConstants {
    ...
    public static class Reef {
        ...
        public static final double FACE_TO_ZONE_LINE = Units.inchesToMeters(12); // Side of the reef to the
        // inside of
        // the reef zone line

        public static final Pose2d[] CENTER_FACES = new Pose2d[6]; // Starting facing the driver station in
        // clockwise
        // order
        public static final List<Map<ReefHeight, Pose3d>> BRANCH_POSITIONS = new ArrayList<>(); // Starting at
