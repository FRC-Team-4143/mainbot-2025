...
public class FieldRegions {
  ...
  public static PolygonRegion PROCESSOR_REGION = new PolygonRegion(
      ...
      "PROCESSOR_REGION");
  public static PolygonRegion PROCESSOR_DEAD_REGION = new PolygonRegion(
      new Translation2d[] {
          new Translation2d(4, 0),
  ...
  public static PolygonRegion L4_COLLISION_REGION = new PolygonRegion(
      new Translation2d[] {
  ...
  public static PolygonRegion OPP_REEF_FACE0_REGION = new PolygonRegion(
      new Translation2d[] {
          FieldConstants.Reef.CENTER,
          // approximation of the right side of the right coral station
          new Translation2d(0, Units.inchesToMeters(50)),
  ...
  public static PolygonRegion OPP_REEF_FACE1_REGION = new PolygonRegion(
      new Translation2d[] {
          FieldConstants.Reef.CENTER,
          // approximation of the left side of the left coral station
          new Translation2d(0, FieldConstants.FIELD_WIDTH - Units.inchesToMeters(50)),
  ...
  public static PolygonRegion OPP_REEF_FACE2_REGION = new PolygonRegion(
      new Translation2d[] {
          FieldConstants.Reef.CENTER,
          // approximation of an imaginary line drawn from the right side of face2
          // to the left side of the field
  ...
  public static PolygonRegion OPP_REEF_FACE3_REGION = new PolygonRegion(
      new Translation2d[] {
          FieldConstants.Reef.CENTER,
          new Translation2d(
              FieldConstants.FIELD_LENGTH / 2,
  ...
  public static PolygonRegion OPP_REEF_FACE4_REGION = new PolygonRegion(
      new Translation2d[] {
          FieldConstants.Reef.CENTER,
          // approximation of an imaginary line drawn from the left side of face4
          // to the right side of the field
  ...
  public static PolygonRegion OPP_REEF_FACE5_REGION = new PolygonRegion(
      new Translation2d[] {
          FieldConstants.Reef.CENTER,
          // approximation of an imaginary line drawn from the left side of the
          // face to the right side of the field
  ...
  public static CircularRegion REEF_ENTER_REGION = new CircularRegion(FieldConstants.Reef.CENTER, 3,
      "REEF_ENTER_REGION");
  public static CircularRegion REEF_EXIT_REGION = new CircularRegion(FieldConstants.Reef.CENTER, 2, "REEF_EXIT_REGION");

  // Region Lists
  public static ArrayList<PolygonRegion> ALGAE_REGIONS = new ArrayList<>(List.of(BARGE_REGION, PROCESSOR_REGION));
  public static ArrayList<PolygonRegion> STATION_REGIONS = new ArrayList<>(
      List.of(
          RIGHT_CORAL_STATION_REGION,
          LEFT_CORAL_STATION_REGION,
          RIGHT_CORAL_STATION_SLOW_REGION,
          LEFT_CORAL_STATION_SLOW_REGION));
  public static ArrayList<PolygonRegion> REEF_REGIONS = new ArrayList<>(
      List.of(
          REEF_FACE0_REGION,
          REEF_FACE1_REGION,
          REEF_FACE2_REGION,
  ...
  private static ArrayList<Region> ALL_REGIONS = new ArrayList<>(
      List.of(
          BARGE_REGION,
          BARGE_ENTER,
          PROCESSOR_REGION,
  ...
  public static void makeRegions() {
    ...
    ScoringPoses.OPP_REEF_FACE_0_POSE = AllianceFlipUtil.apply(ScoringPoses.OPP_REEF_FACE_0_POSE,
        FieldConstants.SYMMETRY_TYPE);
    ScoringPoses.OPP_REEF_FACE_1_POSE = AllianceFlipUtil.apply(ScoringPoses.OPP_REEF_FACE_1_POSE,
        FieldConstants.SYMMETRY_TYPE);
    ScoringPoses.OPP_REEF_FACE_2_POSE = AllianceFlipUtil.apply(ScoringPoses.OPP_REEF_FACE_2_POSE,
        FieldConstants.SYMMETRY_TYPE);
    ScoringPoses.OPP_REEF_FACE_3_POSE = AllianceFlipUtil.apply(ScoringPoses.OPP_REEF_FACE_3_POSE,
        FieldConstants.SYMMETRY_TYPE);
    ScoringPoses.OPP_REEF_FACE_4_POSE = AllianceFlipUtil.apply(ScoringPoses.OPP_REEF_FACE_4_POSE,
        FieldConstants.SYMMETRY_TYPE);
    ScoringPoses.OPP_REEF_FACE_5_POSE = AllianceFlipUtil.apply(ScoringPoses.OPP_REEF_FACE_5_POSE,
        FieldConstants.SYMMETRY_TYPE);
  ...
  public static void flipRegions() {
    ...
    ScoringPoses.REEF_FACE_0_POSE = AllianceFlipUtil.apply(ScoringPoses.REEF_FACE_0_POSE, FieldConstants.SYMMETRY_TYPE);
    ScoringPoses.REEF_FACE_1_POSE = AllianceFlipUtil.apply(ScoringPoses.REEF_FACE_1_POSE, FieldConstants.SYMMETRY_TYPE);
    ScoringPoses.REEF_FACE_2_POSE = AllianceFlipUtil.apply(ScoringPoses.REEF_FACE_2_POSE, FieldConstants.SYMMETRY_TYPE);
    ScoringPoses.REEF_FACE_3_POSE = AllianceFlipUtil.apply(ScoringPoses.REEF_FACE_3_POSE, FieldConstants.SYMMETRY_TYPE);
    ScoringPoses.REEF_FACE_4_POSE = AllianceFlipUtil.apply(ScoringPoses.REEF_FACE_4_POSE, FieldConstants.SYMMETRY_TYPE);
    ScoringPoses.REEF_FACE_5_POSE = AllianceFlipUtil.apply(ScoringPoses.REEF_FACE_5_POSE, FieldConstants.SYMMETRY_TYPE);
    ...
    ScoringPoses.BARGE_TIGHT_ROPE = AllianceFlipUtil.apply(ScoringPoses.BARGE_TIGHT_ROPE, FieldConstants.SYMMETRY_TYPE);
    ScoringPoses.PROCESSOR_TIGHT_ROPE = AllianceFlipUtil.apply(ScoringPoses.PROCESSOR_TIGHT_ROPE,
        FieldConstants.SYMMETRY_TYPE);
