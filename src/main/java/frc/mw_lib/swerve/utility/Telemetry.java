...
public class Telemetry {
  ...
  MechanismLigament2d[] m_moduleSpeeds =
      new MechanismLigament2d[] {
        ...
        // m_moduleMechanisms[1].getRoot("RootSpeed", 0.5, 0.5).append(new
        // MechanismLigament2d("Speed", 0.5, 0)),
        // m_moduleMechanisms[2].getRoot("RootSpeed", 0.5, 0.5).append(new
        // MechanismLigament2d("Speed", 0.5, 0)),
  ...
  public void telemeterize() {
    ...
    for (int i = 0; i < 2; ++i) { // 4
      ...
      m_moduleSpeeds[i].setLength(
          swerveDrivetrain.getModuleStates()[i].speedMetersPerSecond / (2 * MaxSpeed));
