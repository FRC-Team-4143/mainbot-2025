...
public class ModuleType {
    ...
    // MK4I
    public static final ModuleType MK4I_L1 = new ModuleType("MK4I-L1", 150 / 7.0, 8.14);
    public static final ModuleType MK4I_L2 = new ModuleType("MK4I-L2", 150 / 7.0, 6.75);
    public static final ModuleType MK4I_L3 = new ModuleType("MK4I-L3", 150 / 7.0, 6.12);
    public static final ModuleType MK4I_L4 = new ModuleType("MK4I-L4", 150 / 7.0, 5.14);
